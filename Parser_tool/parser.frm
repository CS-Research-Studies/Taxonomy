...
Begin VB.Form Form1 
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      Tab(0).Control(15)=   "Command10"
      Tab(0).Control(15).Enabled=   0   'False
      Tab(0).Control(16)=   "Command11"
      ...
      Begin MSDBGrid.DBGrid DBGrid3 
         Bindings        =   "parser.frx":0054
         Height          =   9240
         Left            =   -74325
         OleObjectBlob   =   "parser.frx":0068
         TabIndex        =   23
         Top             =   1350
         Width           =   12240
      End
      ...
      Begin VB.ListBox List2 
         Height          =   2310
         ItemData        =   "parser.frx":0AA5
         Left            =   11475
         List            =   "parser.frx":0AA7
         Sorted          =   -1  'True
         Style           =   1  'Checkbox
         TabIndex        =   11
         Top             =   5925
      ...
      Begin MSDBGrid.DBGrid DBGrid2 
         Bindings        =   "parser.frx":146F
         Height          =   7665
         Left            =   6000
         OleObjectBlob   =   "parser.frx":1483
         TabIndex        =   10
         Top             =   975
         Width           =   4965
      End
...
x_cat = Mid(x_lt.Fields("categoria"), 1, 10) + " " + x_lt.Fields("descritor")

Open App.Path + "\regras\" + x_cat + ".txt" For Output As #1
Print #1, "const " + x_lt.Fields("descritor") + "Rules = {"
...
While Not x_lt.EOF
      ...
      If x_cat = Mid(x_lt.Fields("categoria"), 1, 10) + " " + x_lt.Fields("descritor") Then
         If x_desc <> x_lt.Fields("descritor") Then
            If x_desc <> "" Then
               'Print #1, "],"
            End If

            Print #1, vbNewLine + x_lt.Fields("descritor") + "_rules: [" + vbNewLine
            x_desc = x_lt.Fields("descritor")
         End If
      
         Print #1, Space(10) + "'" + IIf(Not IsNull(x_lt.Fields("antecessor")), x_lt.Fields("antecessor") + " ", "") + _
                                     IIf(Not IsNull(x_lt.Fields("descritor")), x_lt.Fields("descritor"), "") + _
                                     IIf(Not IsNull(x_lt.Fields("sucessor")), " " + x_lt.Fields("sucessor"), "") + "' ,"
      Else
         Print #1, "],};"
...
Set x_lt = x_db.OpenRecordset("Select * from Learning_Table order by categoria, descritor")
Set Data3.Recordset = x_lt
